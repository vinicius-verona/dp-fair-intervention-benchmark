...
echo "Generating FolkTables [DP] datasets"
for SEED in "${SEEDS[@]}"
do
    python3 dp_folktables_dataset_generator.py $SEED $SAVE_PATH > folktables_gen_seed_$SEED.out 2> folktables_gen_seed_$SEED.err &
done